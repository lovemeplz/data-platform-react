 ...
 * @LastEditTime: 2023-10-26 15:59:53
 */
/*
 * @Descripttion:
 * @Version: v0.1.0
 ...
 * @Date: 2023-09-12 16:46:14
 * @LastEditors: shenziqiang
 * @LastEditTime: 2023-10-25 16:36:56
 */
// @ts-ignore
/* eslint-disable */
...
export async function getRole(
  ...
  const res = await request<API.RuleList>('/api/v1/sys/role', {
    method: 'GET',
    params,
    ...(options || {}),
  });
...
export async function updateRole(body: API.RoleListItem, options?: { [key: string]: any }) {
  return request<API.RuleListItem>('/api/v1/sys/roles', {
    method: 'PUT',
    params: body,
    ...(options || {}),
  });
